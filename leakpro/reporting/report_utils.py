...
def get_config_name(config: BaseModel) -> str:
    ...
    exclude = ["attack_data_dir", "min_num_memorization_audit_points", "num_memorization_audit_points", "memorization", "use_privacy_score", "memorization_threshold", "clf_model_kwargs"]
